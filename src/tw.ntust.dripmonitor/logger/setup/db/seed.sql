...
--
-- Host: localhost
-- Generation Time: Mar 03, 2018 at 07:05 PM
...
CREATE TABLE `event_log` (
  ...
  `mac_adapter` varchar(16) COLLATE utf8_unicode_ci NOT NULL,
...
--
ALTER TABLE `tcp_log_stream`
  MODIFY `sn` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7806;
